    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='signup-n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23signup-n)' opacity='0.03'/%3E%3C/svg%3E\")",
          pointerEvents: "none",
          zIndex: 0,
          opacity: 0.4,
        }}
        ...
        >
          ...
          {loading ? (
            ...
            >
              ...
              />
              <p style={{ fontSize: 13, color: "rgba(232,240,232,0.45)" }}>
                Регистрация...
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                >
                  Имя пользователя{" "}
                  <span style={{ color: "rgba(232,240,232,0.35)", fontWeight: 400 }}>(необязательно)</span>
                </label>
                <input
                  type="text"
                  value={username}
